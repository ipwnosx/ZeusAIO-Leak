        ...
        while (true)
        {
          try
          {
            using (HttpRequest httpRequest = new HttpRequest())
            {
              ...
              httpRequest.UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36";
              httpRequest.IgnoreProtocolErrors = true;
              httpRequest.AllowAutoRedirect = true;
              httpRequest.AddHeader("Host", "home.mcafee.com");
              httpRequest.AddHeader("Connection", "keep-alive");
              httpRequest.AddHeader("Cache-Control", "max-age=0");
              httpRequest.AddHeader("Origin", "https://home.mcafee.com");
